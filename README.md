...
- **Class window and time left.** Once a class starts, a line under its name shows its actual start–end window and how much class time is left overall — with the same small-seconds styling as the clock — turning red with a "+over" once it runs past its own end.
